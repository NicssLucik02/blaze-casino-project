...
import { useCrashStore, LastCashout } from '@/store/useCrashStore';
import { drawSky } from './animations/drawSky';
import { createStarsManager } from './animations/stars';
import { createPlanetsManager } from './animations/planets';
import { createCometsManager } from './animations/comets';
import { createExplosionManager } from './animations/explosion';
import { drawRocket } from './animations/drawRocket';
import { drawAxes } from './animations/drawAxes';
...
export const useCrashGameCanvas = () => {
  ...
  useEffect(() => {
    ...
    const planetsManager = createPlanetsManager();
    ...
    planetsManager.spawnPlanet(canvas.width, canvas.height);
    setTimeout(
      () => planetsManager.spawnPlanet(canvas.width, canvas.height),
      1500
    );
